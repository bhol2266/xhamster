        ...
        <div className='relative h-screen' >
            ...
            <div className=''>
                ...
                <div className='flex items-center justify-center pt-2 lg:pt-5'>
                    <p className=' align-center text-center font-Dancing font-bold text-white  text-[50px] lg:text-[80px] cursor-pointer lg:text-left select-none'>Xhamster</p>
                        ...
                        <div key={index} className="flex items-center justify-between mb-2 py-3 px-4 lg:px-8 lg:py-4  bg-white bg-opacity-80 rounded-md cursor-pointer select-none" onClick={() => handlePlanChange(plan)}>
                            <div className='flex items-center'>
                                <input
                                    ...
                                    className="form-radio h-5 w-5 lg:h-6 lg:w-6 mr-2 lg:mr-3 text-theme_red border-theme_red focus:ring-theme_red"
                                />
