    ...
    return (
        <>
            ...
            <Head>
                ...
                <title>{`${capitalizeFirstLetter(pornstarname.replace('+', " ").replace("+", " "))} Porn Videos - xHamster | ${currentPageNumberURL}`}</title>
                ...
                <meta property="og:title" content={`${capitalizeFirstLetter(pornstarname.replace('+', " ").replace("+", " "))} Porn Videos - xHamster`} />
                ...
                <meta name="twitter:title" content={`${capitalizeFirstLetter(pornstarname.replace('+', " ").replace("+", " "))} Porn Videos - xHamster`} />
                ...
                <link rel="canonical" href={`https://www.xhamster.gg/pornstar/${code}/${pornstarname}/page/${page}`} />
